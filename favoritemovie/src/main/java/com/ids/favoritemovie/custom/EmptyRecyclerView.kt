package com.ids.favoritemovie.custom
...
/**
 * Created with love by Muhajir Shiddiq Al Faruqi on 07,April,2020.
 * Email : infinitydsolution@gmail.com
 * Company : Infinity Digital Solution
 */
public class EmptyRecyclerView @JvmOverloads constructor(
        context: Context,
