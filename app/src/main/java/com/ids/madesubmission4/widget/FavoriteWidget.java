...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.ids.madesubmission4.EXTRA_ITEM";
    private static final String TOAST_ACTION = "com.ids.madesubmission4.TOAST_ACTION";

    public static void updateWidget(Context context){
        try {
            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
            int[] widgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, FavoriteWidget.class));
