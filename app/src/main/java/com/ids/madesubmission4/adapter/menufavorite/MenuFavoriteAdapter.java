package com.ids.madesubmission4.adapter.menufavorite;
 ...
 */
public class MenuFavoriteAdapter extends FragmentPagerAdapter {
    ...
    public MenuFavoriteAdapter(Context context, FragmentManager fm) {
